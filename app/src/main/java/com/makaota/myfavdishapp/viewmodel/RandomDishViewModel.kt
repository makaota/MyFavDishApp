...
import com.makaota.myfavdishapp.model.entities.RandomDish.Recipes
import com.makaota.myfavdishapp.model.network.RandomDishApiService
...
class RandomDishViewModel : ViewModel() {
    ...
    fun getRandomRecipeFromAPI(){
        ...
        compositeDisposable.add(  // Call the RandomDish method of RandomDishApiService class.
